  ...
  return (
    <div className="flex flex-col gap-8">
      <p className="text-muted text-sm">
        Vários caixas podem ficar abertos ao mesmo tempo neste evento (totem, caixas volantes,
        tablets) — este aparelho lembra qual é o seu.
      </p>
