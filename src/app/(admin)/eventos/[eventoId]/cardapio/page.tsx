...
export default async function CardapioPage() {
  ...
  return (
    <div className="flex flex-col gap-8">
      <p className="text-muted text-sm">Cardápio do produtor, vale para os eventos dele.</p>
      ...
      {produtos.length === 0 ? (
        <p className="text-muted">Nenhum produto cadastrado ainda para este produtor.</p>
      ) : (
